...
<div class="title w-full border-b-4 rounded-b-sm border-b-[#0F4061]">
    <h2 class="font-bold text-2xl inline ml-14"><i class="bx bx-image-alt text-2xl"></i>Daftar Banner</h2>
</div>

<div class="container pt-5">
    <a href="/dashboard/carousel/create" class="py-2 px-3 rounded-lg bg-blue-700 text-white hover:bg-blue-800">Tambah Banner</a>
